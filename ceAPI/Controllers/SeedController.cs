...
namespace ceAPI.Controllers
{
    ...
    [ApiController]
    public class SeedController(WorldCitiesContext context, IHostEnvironment environment) : ControllerBase
    {
        private readonly string _pathName = Path.Combine(environment.ContentRootPath, "worldcities.csv");
        [HttpPost ("Countries")]
